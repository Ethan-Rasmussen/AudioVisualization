...
# Here is were you draw the current background picture, and then you wanna print any input boxes AFTER
#   the background has already been printed...
    ...
    if(mode == 'userXYZ'):
        ...
        if (locked_in == False):
            for box in input_boxes:
                box.draw(screen)
                screen.blit(box.txt_surface, (box.rect.x+5, box.rect.y+5)) 
