...
class ourFont:
    ...
    def render_text(self, text, screen, x, y):
        ...
        for char in text:
            ...
            if not(char == ''):
                try:
                    char_image_name = self.get_filename_key(char)
                finally:                    
                    if(char.isalpha() and char.isupper()):
                        char_image_name = f"{char}U.png"
                    elif(char.isalpha()):
                        char_image_name = f"{char}.png"
                    elif(char == '/'):
                        char_image_name = f"_SLASH.png"
                    elif(char == '*'):
                        char_image_name = f"_ASTERISK.png"
                    elif(char == '-'):
                        char_image_name = f"_DASH.png"
                    elif(char == '+'):
                        char_image_name = f"_PLUS.png"
                    elif(char == ' '):
                        char_image_name = f"_SPACE.png"
                    else:
                        char_image_name = f"_{char}.png"
...
while running:
    ...
    font.render_text('SGFBSGNGERNfdgbgnuyktt463ik4,', screen, 100, 148)
    pygame.display.flip()
