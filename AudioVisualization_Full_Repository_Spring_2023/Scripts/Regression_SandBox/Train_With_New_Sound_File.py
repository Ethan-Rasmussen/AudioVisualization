...
#     except:
#         raw_sounds = load_raw_sounds_from_file('cal_data.df')
# #         current_model = train_neural_network(raw_sounds)
#         current_model = train_linear_model(raw_sounds)
...
#     
#     #current_model = train_neural_network(new_raw_sounds)
#     
#     # Read new raw sound data from file
#     new_raw_sounds = load_raw_sounds_from_file(file_with_new_data)
